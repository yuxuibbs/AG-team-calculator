...
rankings = change_data('State Qualifying \'20.xlsx',
                        'All Saturdays',
                        ['FirstName', 'LastName', 'Grade', 'Saturdays', 'Fridays', 'Total', '11-Jan'],
                        'FirstName', 
                        ['11-Jan'])

satTourn.to_csv('saturday_tournaments.csv', index=False)
friTourn.to_csv('individual_rankings.csv', index=False)
